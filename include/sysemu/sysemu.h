...
#ifndef SYSEMU_SYSEMU_H_
#define SYSEMU_SYSEMU_H_
...
extern const char *keyboad_layout;
...
typedef struct QEMUOptionRom QEMUOptionRom;
...
void hmp_pcie_aer_inject_error(Monitor *mom, const QDict *qdict);

// Serial ports
Chardev *serial_hd(int i);
// the number of serial ports defined by the user
...
void device_add_bootindex_property(Object *obj, int32_t *bootindex,
                                   const char *name, const char *suffix, DeviceState *dev, Error **errp);
